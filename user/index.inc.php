...
//echo $_SERVER['PHP_SELF'];
  include('profile_loader.inc.php');
  return;
    ...
    while($row = db_fetch_object($res))
    {
      ...
      ?>
        ...
        <span class="stripinfo">
          <img src="<?=IMAGE_HOST?>/site_gfx_new_v2/genre_icons/<?=$row->category?>.gif" alt="Genre: <?=$COMIC_CATS[$row->category]?>" title="Genre: <?=$COMIC_CATS[$row->category]?>" width="12" height="12" />
