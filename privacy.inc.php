<div class="content" style='padding:75px;' align='left'>
  ...
  <p>We may share your personal information with our affiliates or other companies in our corporate family. We may provide your personal information to other companies whom we may utilize in processing our online transactions or other services. We may be required by law to disclose your personal information, such as in response to a court order or subpoena or at a law enforcement agency's request, and we reserve the right to do so. We may share your personal information as part of a purchase or sale pursuant to appropriate confidentiality provisions, such as if WOWIO, INC merges with another company or sells a business division.</p>
  <h4>Opt-Out Choices</h4>
  <p>You may always choose to opt out of receiving promotional materials. If you wish to opt out of receiving such correspondence, please follow the opt-out instructions included in the applicable correspondence.</p>
  <h4>Updating or Correcting Your Personal Information</h4>
  <p>If you wish to review, update or correct any of your personal information in this Website's possession, please contact us using the contact information provided below.</p>
  <h4>Security Measures</h4>
  <p>Not all information provided while using this Website is necessarily secure against electronic interception or tampering. While this Website does incorporate secure software and encryption to protect certain sensitive information you may provide, as with any Internet transmission, there is always some element of risk in sending personal information. For that reason, WOWIO, INC cannot guarantee that all personal or other sensitive information will remain confidential, and we must disclaim any liability for the inadvertent or unknowing disclosure or use of such information.</p>
  <h4>Child Online Privacy</h4>
  <p>This Website is not generally intended for anyone under the age of 18. We do not knowingly collect personal information from children under the age of 13. If you are 13 or under, please do not submit your personal information on this Website. </p>
  <h4>Links to Other Sites</h4>
  <p>This Website may contain links to other sites. We are not responsible for the privacy policies or practices, content, or any other aspect of these other sites, and you link to them at your own risk.</p>
  <h4>Changes to this Privacy Policy</h4>
  <p>We may change this Website's policies concerning the use of your personal information and other privacy policies from time to time. We will post any such changes on this Website. For that reason, we encourage you to periodically review this privacy policy to keep yourself informed of any changes.</p>
  <h4>How to Contact Us</h4>
  <p>We encourage you to share any comments or concerns you may have about this privacy policy or other aspects of this Website at the address given below. However, please note that by accessing this Website or submitting your personal information, you acknowledge and agree to be bound by this privacy statement, as amended or revised from time to time, in addition to all other terms of use posted at this Website.</p>
  <p>For questions about this privacy policy or to contact us:</p>
  ...
  <hr />
  <h2><a name="copyright" id="copyright"></a>Copyright and Authorized Use</h2>
  <p>All materials contained in this website (&quot;Website Materials&quot;) including comic strips, books, art, illustrations, images, or text are trademarks or copyrighted materials owned and controlled by WOWIO, INC or its subsidiaries, affiliated entities and/or third-party licensors and/or individual creators, and are protected by applicable trademark and/or copyright law. </p>
