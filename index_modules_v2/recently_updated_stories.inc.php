...
<img src="<?=IMAGE_HOST_SITE_GFX?>/sect_stories2.gif" width="212" height="30" />
<div class="narrow">
  ...
  $ct = 0;
  $res = db_query("SELECT comic_name, last_update, category, flags FROM comics WHERE comic_type='1' ".$extra." AND total_pages>0 AND delisted=0 ORDER BY last_update DESC LIMIT 25");
  ...
  <div align="right">
    <a href="#" onClick="showMoreStories();return false;"><img src="<?=IMAGE_HOST_SITE_GFX?>/smbtns_more.gif" width="56" height="14" border="0" /></a>
