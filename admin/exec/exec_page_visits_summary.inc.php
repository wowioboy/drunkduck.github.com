...
<DIV STYLE='WIDTH:810px;' ALIGN='CENTER' CLASS='container'>
  <DIV CLASS='header' ALIGN='CENTER'>Page Visits</DIV>
...
$DISTINCT_RES = db_query("SELECT * FROM page_statistics WHERE (file_name='/index.php' OR file_name LIKE '/tutorials/%') ORDER BY ymd_date DESC");
while( $YMD_ROW = db_fetch_object($DISTINCT_RES) )
{
  if ( substr($YMD_ROW->page_title, 0, strlen('User Lookup!')) != 'User Lookup!' )
  {
    ...
    $amt = $YMD_ROW->views * $YMD_ROW->multiplier;
