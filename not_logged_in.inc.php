...
<div align="center"><img src="<?=IMAGE_HOST_SITE_GFX?>/login_r1_c1.gif" width="60" height="20" />
      ...
      <INPUT TYPE='TEXT' NAME='un' VALUE='username' onFocus="this.value='';" STYLE='HEIGHT:20px;WIDTH:100px;'>


  <img src="<?=IMAGE_HOST_SITE_GFX?>/login_r2_c1.gif" width="60" height="20" />


  <INPUT TYPE='PASSWORD' NAME='pw' VALUE='password' onFocus="this.value='';" STYLE='HEIGHT:20px;WIDTH:100px;'>
...
<p align="center">Members can:
   <br />
   &bull; Comment on comics!<br />
   &bull; Create their own comics!<br />and vote in polls and contests!
