...
$GLOBALS['QUERY'] = "SELECT comic_id, comic_name, last_update, category, rating_symbol, flags FROM comics WHERE ".implode(' AND ', $WHERE)." ORDER BY seven_day_visits DESC LIMIT 10";
?>
...
<?
cached_include(WWW_ROOT.'/xmlhttp/main_page/racks/rack_query.inc.php', 300, '10spot');
?>