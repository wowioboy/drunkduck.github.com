...
$(document).ready(function(){
  ...
  $('.quack-reply-button').click(function(){
    ...
    window.location = '/control_panel/compose-quack.php?to=' + from + '&subject=RE: ' + subject;
  });
});
</script>
...
<a class="yellow-button" href="javascript:">inbox</a>
...
<table class="quack-table" width="100%" style="clear:both;margin-top:20px;">
  ...
  <tr sytle="padding:0;height:10px;"><td colspan="5" style="padding:0;-moz-border-radius:10px 10px 0 0;border-radius:10px 10px 0 0;height:10px;"></td></tr>
    ...
    <tr class="<?php echo $quack['status']; ?>" quack="<?php echo $quack['id']; ?>">
      <td>
...
<div class="table fill">
  ...
  <div class="cell center">
    <button class="button" id="quack-delete-button">delete selected</button>
  </div>
